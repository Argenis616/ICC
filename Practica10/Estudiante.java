...
public class Estudiante implements Registro {
    ...
    @Override public boolean equals(Object o) {
		if(o instanceof Estudiante){
			...
			if(estudiante.nombre.get().equals(nombre.get())&&
			estudiante.cuenta.get()==cuenta.get()&&
			Double.compare(promedio.get(),estudiante.promedio.get())==0
			&&estudiante.edad.get()==edad.get())
			return true;
			return false;
		} return false;
        // Aquí va su código.
